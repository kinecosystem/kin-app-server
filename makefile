...
test:
	...
	# python -m pytest -v -rs -s -x  --disable-pytest-warnings kinappserver/tests/migrate_tasks.py
	...
	# python -m pytest -v -rs -s -x  --disable-pytest-warnings kinappserver/tests/task_results_out_of_order.py # disabled until we decide how to handle this
	# python -m pytest -v -rs -s -x  --disable-pytest-warnings kinappserver/tests/count_immediate_tasks.py
