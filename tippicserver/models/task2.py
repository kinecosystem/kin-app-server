...
from tippicserver.models.task import Task
from tippicserver.push import send_please_upgrade_push
from tippicserver.utils import InvalidUsage, InternalError, seconds_to_local_nth_midnight, OS_ANDROID, OS_IOS, DEFAULT_MIN_CLIENT_VERSION, test_image, test_url, get_country_code_by_ip, increment_metric, commit_json_changed_to_orm
from tippicserver.models import store_next_task_results_ts, get_next_task_results_ts, get_user_os_type, get_user_app_data, get_unenc_phone_number_by_user_id
...
def store_task_results(user_id, task_id, results):
    ...
    try:
        ...
        from tippicserver.models import UserAppData
...
def handle_task_results_resubmission(user_id, task_id):
    ...
    """
    from tippicserver.models import get_memo_for_user_ids
...
def get_truex_activity(user_id, cat_id, remote_ip, user_agent=None):
    ...
    from tippicserver.truex import get_activity
