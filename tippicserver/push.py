...
from tippicserver import app, config
from tippicserver.utils import InvalidUsage, OS_IOS, OS_ANDROID, increment_metric
import redis
...
def send_p2p_push(user_id, amount, tx_dict):
    ...
    from tippicserver.models import get_user_push_data
