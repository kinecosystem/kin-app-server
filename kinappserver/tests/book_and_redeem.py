...
class Tester(unittest.TestCase):
    ...
    def test_book_and_redeem(self):
        ...
        db.engine.execute(
            """update public.push_auth_token set auth_token='%s' where user_id='%s';""" % (str(userid1), str(userid1)))
        ...
        tx_hash_wrong_address = stellar.send_kin('GCKG5WGBIJP74UDNRIRDFGENNIH5Y3KBI5IHREFAJKV4MQXLELT7EX6V',
